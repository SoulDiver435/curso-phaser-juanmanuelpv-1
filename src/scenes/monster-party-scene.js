...
export class MonsterPartyScene extends BaseScene {
  ...
  create() {
    ...
    this.#cancelButton = this.add
      .image(0, 0, UI_ASSETS_KEYS.BLUE_BUTTON, 0)
      .setOrigin(0)
      .setScale(0.7, 1)
      .setAlpha(0.7);
    ...
    this.#infoTextGameObject = this.add.text(15, 14, "dsfsd", {
      ...UI_TEXT_STYLE,
      color: "#000000",
      fontSize: "23px",
    });
  ...
  #createMonster(x, y, monsterDetails) {
    ...
    middleShadowCap.displayWidth = 285;
  ...
  #movePlayerInputCursor(direction) {
    switch (direction) {
      case DIRECTION.UP:
        ...
        this.#cancelButton
          .setTexture(UI_ASSETS_KEYS.BLUE_BUTTON, 0)
          .setAlpha(0.7);
        break;
      case DIRECTION.DOWN:
        if (this.#selectedPartyMonsterIndex === -1) {
        ...
        if (this.#selectedPartyMonsterIndex === -1) {
          this.#cancelButton
            .setTexture(UI_ASSETS_KEYS.BLUE_BUTTON_SELECTED, 0)
            .setAlpha(1);
          break;
        }
